#!/usr/bin/env python3
"""
YOLOv8n Benchmark for Raspberry Pi 4B
...
def run_camera_benchmark(model_path, duration, format_type='pt'):
    ...
    print(f"\n{'='*60}")
    print("YOLOv8n Camera Benchmark")
    print(f"{'='*60}")
    ...
    # Initialize logger
    logger = BenchmarkLogger("yolov8n", model_format=format_type)
...
def main():
    parser = argparse.ArgumentParser(
        description='YOLOv8n Benchmark for Raspberry Pi 4B',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Camera benchmark for 60 seconds (PyTorch)
  python3 run_yolov8_new.py --duration 60
  
  # Camera benchmark with NCNN format (fastest)
  python3 run_yolov8_new.py --duration 60 --format ncnn
  
  # Image benchmark
  python3 run_yolov8_new.py --image test.jpg --iterations 100
        """
    )
